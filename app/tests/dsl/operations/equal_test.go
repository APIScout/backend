...
func TestEqualOperatorString(t *testing.T) {
	...
	if filters == nil ||
		...
		log.Print(strings.Compare(filters[0].Lhs, "api.source") != 0)
		t.Fatal(filters)
	}
}

func TestEqualOperatorBool(t *testing.T) {
...
func TestEqualOperatorInt(t *testing.T) {
...
func TestEqualOperatorVersion(t *testing.T) {
